...
$manual = get_sub_field('enable_manual');
if($manual === true){
    $cta = get_sub_field('request_advice');
    $title = get_sub_field('how_to_hire_it_title');
    $description = get_sub_field('how_to_hire_it_description');
}else{

<?php
$script_handle = "flexible-markets_how_we_do_it-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/flexible-markets_how_we_do_it.min.js",
    array("jquery"),
    null,
    true
);
        ...
        ?>
            <div class="row step-by-step">
                <div class="col-12 col-md-<?= $item['text_colum_size_md']; ?> step-text">
                    ...
                    <?php if(!empty($item['result']['title']) || !empty($item['result']['description'])): ?>
                        <div class="result">

<?php
$script_handle = "flexible-global_true_history-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/flexible-global_true_history.min.js",
    array("jquery"),
    null,
    true
);
...
if(get_sub_field('enable_true_story_repeat')):
$stories = get_sub_field('true_story_repeat');
?>

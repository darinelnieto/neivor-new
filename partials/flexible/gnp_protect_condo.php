<?php
$script_handle = "flexible-gnp_protect_condo-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/flexible-gnp_protect_condo.min.js",
    array("jquery"),
    null,
    true
);
...
$content = get_sub_field('we_protect_your_condominium');
if($content['cards']):
?>

<?php
// $script_handle = "flexible-about_banner-js";
// wp_enqueue_script(
//     $script_handle,
//     get_template_directory_uri() . "/js/partials-min/flexible-about_banner.min.js",
//     array("jquery"),
//     null,
//     true
// );
...
<section class="banner-about-partial-7b9ae8" <?php if($background_img === false): ?>style="<?= $banner['background_gradient']; ?>"<?php endif; ?>>
    ...
    <?php if($background_img === true): ?>
        <?= wp_get_attachment_image($banner['background_image_desktop']['ID'], 'full', false, array(
            'class' => 'background-desktop',
            'fetchpriority' => 'high',
        )); ?>
        <?= wp_get_attachment_image($banner['background_image_movil']['ID'], 'full', false, array(
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-6 image-contain">
                ...
                <?= wp_get_attachment_image($banner['main_image_movil']['ID'], 'full', false, array(

<?php
$script_handle = "flexible-markets_protect_condo-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/flexible-markets_protect_condo.min.js",
    array("jquery"),
    null,
    true
);
...
if(get_sub_field('enable_protect_your_condo')):
    $protected = get_sub_field('protect_your_condo');
?>
<style>

<?php
$script_handle = "flexible-gnp_extraordinary_fees-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/flexible-gnp_extraordinary_fees.min.js",
    array("jquery"),
    null,
    true
);
...
$gray = get_sub_field('extraordinary_fees_gray');
$purple = get_sub_field('extraordinary_fees_purple');
?>

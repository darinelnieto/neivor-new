<?php
$script_handle = "flexible-global_blog-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/flexible-global_blog.min.js",
    array("jquery"),
    null,
    true
);
...
$enable = get_sub_field('enable_blog_by_category');
$cat = get_sub_field('blog_category');
if($enable === true){

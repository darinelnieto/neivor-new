<?php
// $script_handle = "flexible-blog_hero-js";
// wp_enqueue_script(
//     $script_handle,
//     get_template_directory_uri() . "/js/partials-min/flexible-blog_hero.min.js",
//     array("jquery"),
//     null,
//     true
// );
...
?>
<section class="blog-hero-partial-f87f86 <?php if($context === 'hero'): ?>hero-blog<?php elseif($context === 'body'): ?>body-blog<?php endif; ?>">

        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 mb-4 mb-md-0 text-content">
                    <h1 class="title" style="color:<?= get_sub_field('text_color'); ?><?php if(get_sub_field('enable_font_size_by_title') === true): ?>; font-size:<?= get_sub_field('font_size_title'); ?><?php endif; ?>"><?= get_sub_field('main_text'); ?></h1>

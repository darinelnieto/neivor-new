<?php
$script_handle = "flexible-home_v2_boost_business-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/flexible-home_v2_boost_business.min.js",
    array("jquery"),
    null,
    true
);
...
<?php
// Flexible Builder wrapper. Original: partials/home-v2/boost-your-business.php
...
$boost = get_sub_field('boost_your_business_fields_group');
if ( ! $boost ) return;

<?php
$script_handle = "flexible-markets_properties_trust-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/flexible-markets_properties_trust.min.js",
    array("jquery"),
    null,
    true
);
...
$before_properties = get_sub_field('content_group_before_properties_that_trust_neivor');
$properties = get_sub_field('group_content_properties_that_trust_neivor');
?>
<section class="properties-that-trust-neivor-partial-243d09">
    <div class="container">
        <?php if(get_sub_field('enable_content_group_before_properties_that_trust_neivor')): ?>
        ...
        <?php 
            ...
            if(get_sub_field('enable_properties_that_trust_neivor')):
        ?>

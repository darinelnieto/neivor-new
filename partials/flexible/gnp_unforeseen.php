<?php
$script_handle = "flexible-gnp_unforeseen-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/flexible-gnp_unforeseen.min.js",
    array("jquery"),
    null,
    true
);
...
$items = get_sub_field('unforeseen_expenses');
if($items['items']):
?>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="row align-items-center">
                            <div class="col-3 col-md-2">
                                <?= wp_get_attachment_image( $content['icon']['ID'], 'full', false, array(
                                    'class' => 'icon',
                                    'loading' => 'lazy',
                                    'decoding' => 'async',
                                )); ?>

<?php
$script_handle = "home-v2-properties-you-trust-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/home-v2-properties-you-trust.min.js",
    array("jquery"),
    null,
    true
);
...
<section class="new-properties-you-trust-partial-88f88c" style="nackground: <?= $properties['background'] ?? '#ffffff'; ?>">
    <div class="container">
        <?php if($properties['enable_trusting_properties'] === true): $key = 0; ?>
            <div class="row">
                <div class="col-12">

<?php
$script_handle = "markets-comprehensive-protection-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/markets-comprehensive-protection.min.js",
    array("jquery"),
    null,
    true
);
        ...
        <div class="row">
            <div class="col-12 mb-0 mb-md-4">
                <div class="logo-contain">
                    <?= wp_get_attachment_image($protection['logo']['ID'] ?? '', 'large', false, array(
                        'class' => 'd-none d-md-block',
                        'loading' => 'lazy',
                        'decoding' => 'async',
                    )); ?>
                    <?= wp_get_attachment_image($protection['logos_movil']['ID'] ?? '', 'large', false, array(
                    ...
                    <a href="<?= get_field('post_url', $item['comprehensive_protection_item']->ID); ?>" target="_blank">
                        <div class="card-post">
                            <div class="image-contain">
                                ...
                                <span class="icon">
                                    <?= wp_get_attachment_image(get_field('icon', $item['comprehensive_protection_item']->ID)['ID'] ?? '', 'large', false, array(
                                        'class' => 'full-image',
                                        'loading' => 'lazy',
                                        'decoding' => 'async'
                                    )); ?>

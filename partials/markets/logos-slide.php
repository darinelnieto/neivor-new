<?php
$script_handle = "markets-logos-slide-js";
wp_enqueue_script(
    $script_handle,
...
<section class="logos-slide-partial-f8ca70" style="background:<?= get_field('secondary_background', 'option'); ?>">
    ...
    <svg width="300" height="75" class="svg-bottom d-none d-md-block" viewBox="0 0 300 75" fill="none" xmlns="http://www.w3.org/2000/svg">

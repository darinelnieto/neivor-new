<?php
$script_handle = "home-banner-js";
wp_enqueue_script(
    $script_handle,
    get_template_directory_uri() . "/js/partials-min/home-banner.min.js",
    array("jquery"),
    null,
    true
);
...
<section class="banner-partial-4607af">
    ...
    <?php endif; ?>
    <div class="banner-slide <?php if(!is_front_page()): ?>success-stories<?php endif; ?> owl-carousel" data-banner-count="<?= count($banner); ?>">
                        ...
                        <div class="col-12 col-md-6">
                            <?php if($item['enable_video'] === false): ?>
                                <div class="image-contain">
                                    <?= wp_get_attachment_image($item['main_image']['ID'] ?? '', 'large', false, array(
                                        'class' => 'd-none d-md-block',
                                        'fetchpriority' => 'high',
                                        'loading' => 'eager'
                                    )) ?>
                                    <?= wp_get_attachment_image($item['main_image_movil']['ID'] ?? '', 'large', false, array(
